...
sampleText1a = sampleText1.format("Jay","Money", "Mobile Legends")
print(sampleText1a)

sampleText2 = "My name is {0}. I love {1}. I love playing {2}."
sampleText2a = sampleText2.format("Jay", "Scatter","Mobile Legends")
print(sampleText2a)


sampleText3 = "My name is {name}. I love {food}. I love playing {play}."
sampleText3a = sampleText3.format(food="Money", play="Mobile Legends", name="Jay")
print(sampleText3a)
