...
sampleText1a = sampleText1.format("Jamaica", "Watching Videos", "Mobile Legends" , "Apple")
...
sampleText3a = sampleText3.format(food="Fries", play="Mobile legends", name="Jamaica")
print(sampleText3a)
