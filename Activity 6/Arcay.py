...
print(f"Hi everyone I want to introduce my self to you I am !{Attempt}, I have many things to know about {attempt2}. Thank You!")
...
again = "cash"
total = 99000
print("Every day I lost a %s and it cost a toal of %d." % (again, total))
